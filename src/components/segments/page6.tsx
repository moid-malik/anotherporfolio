const Page6 = () => {
    return (
      <div className="h-screen w-full p-4 mt-12">
        <div className="relative w-full h-full flex flex-col bg-black rounded-[50px] lg:px-6 lg:py-20 sm:py-8 py-8 sm:px-8 px-8">
          <video
            autoPlay
            muted
            loop
          ...
          <div className="z-[10] lg:w-[52vw] lg:text-start sm:text-center text-center  text-zinc-400 leading-none flex flex-col gap-2 text-lg">
            <div className="sm:text-sm lg:text-md text-sm">
              <h3 className="tracking-tighter lg:text-xl sm:text-md text-md text-white">PERSONALITY</h3>
              <p>
            ...
            <div className="sm:text-sm lg:text-md text-sm">
              <h3 className="tracking-tighter lg:text-xl sm:text-md text-md text-white">APPROACH</h3>
            ...
            <div className="sm:text-sm lg:text-md text-sm">
              <h3 className="tracking-tighter lg:text-xl sm:text-md text-md text-white">DESIGN</h3>
              <p>
            ...
            <div className="sm:text-sm lg:text-md text-sm">
              <h3 className="tracking-tighter lg:text-xl sm:text-md text-md text-white">FOCUS</h3>
              <p>
          ...
          <div className="lg:mt-24 sm:mt-8 mt-12 text-white leading-none flex justify-between items-center">
            <div>
              <div className="lg:text-3xl sm:text-lg text-lg tracking-[0.6px] font-[helvetica]  uppercase">
                sounds good?
              </div>
            ...
            <div>
              <a
                ...
                className="lg:text-2xl text-md w-full tracking-normal uppercase flex items-center lg:gap-1"
              >
                email me
                <svg
                  width="30px"
