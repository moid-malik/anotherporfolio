  ...
  return (
    ...
    >
      ...
      <div className="group-hover/bento:translate-x-2 transition duration-200">
        {icon}
        <div className="font-sans font-bold text-neutral-900 dark:text-neutral-800 mb-2 mt-2">
          {title}
        </div>
        <div className="font-sans font-normal text-neutral-900 text-xs dark:text-neutral-900">
          {description}
        </div>
      </div>
    </div>
